...
% Locate directories where data will be read from 
MODEL_DIR='C:\IP_BENCHMARK\MODEL_DATASET\';
SUBJECT_DATA_DIR = 'C:\IP_BENCHMARK\HUMAN_SUBJECTs_INTEREST_POINTS\';

% Locate directories where data will be written to
SUBJECT_IP_PARTITIONS_DIR = 'C:\IP_BENCHMARK\OUTPUT_DATA\SUBJECT_IP_PARTITIONS_B\';
